...
public class Servicesevent implements IService<Evenement> {
    ...
    public void ajouter(Evenement t) throws SQLException {
        String req = "INSERT INTO `evenement` (`nom_event`, `date_deb`, `date_fin`, `duree`, `prix`, `id`) VALUES "
    ...
    public void update(Evenement t) throws SQLException {
        String req = "UPDATE evenement SET nom_event=?, date_deb=?, date_fin=?, duree=?, prix=?, id=? WHERE id_event=?";
