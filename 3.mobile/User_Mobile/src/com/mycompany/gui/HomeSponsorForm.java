 ...
 * @author Sondes
 */
public class HomeSponsorForm extends Form {
    ...
    private static final String ADD_BUTTON_TEXT = "Ajouter Sponsor";
    private static final String LIST_BUTTON_TEXT = "Afficher Les Sponsors";

    public HomeSponsorForm(Resources res, SessionManager se) {
        setTitle("Menu");
...
//        addButton.addActionListener(e -> new AddSponsorForm(this).show());
        ...
        listButton.addActionListener(e -> new ListSponsor(this).show());
